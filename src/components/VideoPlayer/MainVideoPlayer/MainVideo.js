function initBunnyPlayer() {
	document
		...
		.forEach(function (player) {
			...
			var progressBar = player.querySelector(
				'[data-player-progress]',
			);
			var bufferedBar = player.querySelector(
				'[data-player-buffered]',
			);
			var handle = player.querySelector(
				'[data-player-timeline-handle]',
			);
			...
			function attachMediaOnce() {
				...
				if (isSafariNative) {
					video.preload =
						isLazyTrue || isLazyMeta ? 'auto' : video.preload;
					video.src = src;
